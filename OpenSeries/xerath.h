...
namespace xerath
{
	...
	inline bool isDodgingWRE(const game_object_script& target);
	...
	inline float getTimeToHit(const prediction_input& input, prediction_output& predInfo, const bool takePing);
	...
	inline bool castQShort(const game_object_script& target, const std::string& mode);
	inline bool castQCharge(const game_object_script& target, const std::string& mode);
	inline bool castQLong(const game_object_script& target, const std::string& mode);
	inline bool castW(const game_object_script& target, const std::string& mode, bool wCenter);
